...
// Enable email rerouting (IF Reroute Email module IS INSTALLED).
...
// $conf['reroute_email_address'] = "developers@example.com";
...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/xoxokitchen/xoxokitchen-settings.inc';
}
...
// Acquia-hosted environments specific configs
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  // Define private files directory
  $conf['file_private_path'] = '/home/xoxokitchen/' . $_ENV['AH_SITE_ENVIRONMENT'] . '/files-private';
  
  // ENV-specific configs
  switch ($_ENV['AH_SITE_ENVIRONMENT']) {
    case 'dev':
      //$base_url = 'DEV DOMAIN HERE';  // NO trailing slash!
      //$cookie_domain = 'DEV COOKIE DOMAIN HERE';
    break;

    case 'test':
      //$base_url = 'TEST DOMAIN HERE';  // NO trailing slash!
      //$cookie_domain = 'TEST COOKIE DOMAIN HERE';
    break;

    case 'prod':
      //$base_url = 'PROD DOMAIN HERE';  // NO trailing slash!
      //$cookie_domain = 'PROD COOKIE DOMAIN HERE';
      
      // Disable email rerouting iа Reroute Email module is used.
  ...
  /**
   * Memcache settings
   * Uncomment below if Memcache Drupal module is available
   * Make sure to set correct paths for incude files below.
   */
  
  // $conf['memcache_key_prefix'] = $_ENV['AH_SITE_ENVIRONMENT'];
