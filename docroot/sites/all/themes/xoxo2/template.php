 ...
 */
 ...
 /**
 * xoxo2: Override of the default form item generation
 ...
 * @ingroup themeable
 */
function xoxo2_form_element($variables) {
...
/**
 * xoxo2: Override of the checkboxes field output
 ...
 * @ingroup themeable
 */
function xoxo2_checkboxes($variables) {
  $element = $variables['element'];
...
function xoxo2_table_cell($cell, $header = FALSE) {
  $attributes = '';
...
function xoxo2_table($variables) {
...
/*function xoxo2_image_widget($variables) {
  $element = $variables['element'];
...
function xoxo2_preprocess_views_exposed_form(&$vars, $hook) {
  $form = &$vars['form'];
...
function xoxo2_form_alter(&$form, &$form_state, $form_id) {
...
function xoxo2_file_upload_help($variables) {
/*if ($form_id == 'user_register_form') {*/
...
function xoxo2_preprocess_views_view_table(&$variables) {
  $table = array(
    '#theme' => 'table',
...
function xoxo2_preprocess_week_pager(&$vars) {
  if($vars['mail']) {
    $vars['theme_hook_suggestions'][] = 'week_pager__mail';
  }
}

function xoxo2_preprocess_views_draggable_unformatted(&$vars) {
  $a = array();
  $b = '';
  $t = !empty($vars['title']);
...
function xoxo2_preprocess_field(&$variables, $hook) {
...
function xoxo2_preprocess_fieldset(&$vars) {
...
function xoxo2_preprocess_page(&$vars) {
...
function xoxo2_menu_local_action($variables) {
...
function xoxo2_preprocess_node(&$vars) {
  if(arg(0) == 'xoxo-popup') {
...
function xoxo2_recipe_node_form($form) {
...
function xoxo2_pager($variables) {
  $tags = $variables['tags'];
  $element = $variables['element'];
...
function xoxo2_js_alter(&$javascript) {
  $file = drupal_get_path('theme', 'xoxo2') . '/js/autocomplete.js';
  $javascript['misc/autocomplete.js'] = drupal_js_defaults($file);

  $file_1 = drupal_get_path('theme', 'xoxo2') . '/js/file.js';
  $javascript['modules/file/file.js'] = drupal_js_defaults($file_1);
}

function xoxo2_preprocess_html(&$variables) {
  if(arg(0) === 'shopping-list' && arg(2) === 'print') {
    $variables['theme_hook_suggestions'][] = 'html__shopping_list__print';
  }
}

function xoxo2_preprocess_block(&$vars) {
...
function xoxo2_menu_alter(&$items)
{
